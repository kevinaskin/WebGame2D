...
module$cn$ucai$game2d$app$Game2dApp["default"]=$jscompDefaultExport$$module$cn$ucai$game2d$app$Game2dApp;var module$cn$ucai$demos$anim$AnimDemo={},AnimDemo$$module$cn$ucai$demos$anim$AnimDemo=function(){module$cn$ucai$game2d$app$Game2dApp["default"].call(this,400,300);document.body.appendChild(this.getDom());this._rect=new module$cn$ucai$game2d$display$Rectangle["default"](100,100,"red");this.addChild(this._rect);var a=new module$cn$ucai$game2d$anim$PropertyAnim["default"](this._rect,"x",0,200,120);a.start();this._rect.addEventListener("click",function(b){a.start()})};
