...
G2DEventDispatcher$$module$org$osdg$game2d$events$G2DEventDispatcher.prototype.removeEventListener=function(a,b){var c=this._listeners.get(a);if(c)if(b){var d=c.indexOf(b);-1!=d&&c.splice(d,1)}else c.length=0};G2DEventDispatcher$$module$org$osdg$game2d$events$G2DEventDispatcher.prototype.dispatchEvent=function(a){var b=this._listeners.get(a.getType());if(b&&0<b.length)for(var c=0;c<b.length;c++)b[c](a)};var $jscompDefaultExport$$module$org$osdg$game2d$events$G2DEventDispatcher=G2DEventDispatcher$$module$org$osdg$game2d$events$G2DEventDispatcher;
module$org$osdg$game2d$events$G2DEventDispatcher["default"]=$jscompDefaultExport$$module$org$osdg$game2d$events$G2DEventDispatcher;var module$org$osdg$game2d$display$Display={},Display$$module$org$osdg$game2d$display$Display=function(){module$org$osdg$game2d$events$G2DEventDispatcher["default"].call(this);this.y=this.x=0;this.scaleY=this.scaleX=1;this.rotation=0;this._enabled=!0;this._parent=null;this._visible=!0};$jscomp.inherits(Display$$module$org$osdg$game2d$display$Display,module$org$osdg$game2d$events$G2DEventDispatcher["default"]);
...
var $jscompDefaultExport$$module$org$osdg$game2d$display$Display=Display$$module$org$osdg$game2d$display$Display;module$org$osdg$game2d$display$Display["default"]=$jscompDefaultExport$$module$org$osdg$game2d$display$Display;var module$org$osdg$game2d$display$Rectangle={},Rectangle$$module$org$osdg$game2d$display$Rectangle=function(a,b,c){module$org$osdg$game2d$display$Display["default"].call(this);this._width=a;this._height=b;this._color=c};$jscomp.inherits(Rectangle$$module$org$osdg$game2d$display$Rectangle,module$org$osdg$game2d$display$Display["default"]);Rectangle$$module$org$osdg$game2d$display$Rectangle.prototype.onDraw=function(a){a.fillStyle=this._color;a.fillRect(0,0,this._width,this._height)};
Rectangle$$module$org$osdg$game2d$display$Rectangle.prototype.hitTestPoint=function(a,b){return a>this.getGlobalX()&&b>this.getGlobalY()&&a<this.getGlobalX()+this._width&&b<this.getGlobalY()+this._height};var $jscompDefaultExport$$module$org$osdg$game2d$display$Rectangle=Rectangle$$module$org$osdg$game2d$display$Rectangle;module$org$osdg$game2d$display$Rectangle["default"]=$jscompDefaultExport$$module$org$osdg$game2d$display$Rectangle;var module$org$osdg$game2d$display$Text={},Text$$module$org$osdg$game2d$display$Text=function(a,b,c,d){module$org$osdg$game2d$display$Display["default"].call(this);this._fontSize=b||10;this._fontFamily=c||"sans-serif";this._color=d||"#000000";this.generateFontString();this._text=a};$jscomp.inherits(Text$$module$org$osdg$game2d$display$Text,module$org$osdg$game2d$display$Display["default"]);Text$$module$org$osdg$game2d$display$Text.prototype.setText=function(a){this._text=a};
